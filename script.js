...
let hamburgerBtn = document.querySelectorAll('.hamburger-menu');
let heroSec = document.querySelector('.hero-sec');
let aboutSec = document.querySelector('.about-sec');
let menuWrapper = document.querySelector('.menu-wrapper');
let closeBtn = document.querySelector('.menu-wrapper img');
let speakersBoxes = document.querySelector('.speakers-boxes');
let players = [
  {
